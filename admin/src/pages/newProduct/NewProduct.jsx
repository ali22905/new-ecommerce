...
export default function NewProduct() {
  ...
  return (
    <div className="login2">
      <div className="container2" style={{ height: "95vh" }}>
        <div className="text2">
          <h1>New Product</h1>
          <div className="inputs">
            <div className="newProduct">
              <form className="addProductForm">
                ...
                <div className="addProductItem">
                  <label>Sizes</label>
                  <div style={{ width: "100%", display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gridGap: "10px" }}  >
                    {data.sizeType === "kids" ? (
                      <h3>
                        from{" "}
                        <input
                          ...
                          name="kidsSizeFrom"
                          onChange={handleChange}
                          value={data.kidsSizeFrom}
                        />{" "}
                        to{" "}
                        <input
                          name="kidsSizeTo"
                          onChange={handleChange}
                          value={data.kidsSizeTo}
                          type="number"
                        />
                      </h3>
                    ) : (
            ...
            <button onClick={handleSubmit} className="addProductButton bt2">
              Create
            </button>
          </div>
        </div>
